    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add New Formateur</h4>
                        <p class="card-description">Enter formateur details</p>
                        ...
                        <form method="POST" action="{{ route('formateur.store') }}" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary">Create Formateur</button>
